...
INSERT INTO
  public.driver (first_name, last_name, team_id, driver_number, created_at)
VALUES
  ('Alexander', 'Albon', (SELECT id FROM inserted_teams WHERE team_name = 'Williams'), 23, CURRENT_TIMESTAMP),
  ('Fernando', 'Alonso', (SELECT id FROM inserted_teams WHERE team_name = 'Aston Martin'), 14, CURRENT_TIMESTAMP),
  ('Valtteri', 'Bottas', (SELECT id FROM inserted_teams WHERE team_name = 'Kick Sauber'), 77, CURRENT_TIMESTAMP),
  ('Pierre', 'Gasly', (SELECT id FROM inserted_teams WHERE team_name = 'Alpine'), 10, CURRENT_TIMESTAMP),
  ('Lewis', 'Hamilton', (SELECT id FROM inserted_teams WHERE team_name = 'Mercedes'), 44, CURRENT_TIMESTAMP),
  ('Nico', 'Hülkenberg', (SELECT id FROM inserted_teams WHERE team_name = 'Haas'), 27, CURRENT_TIMESTAMP),
  ('Charles', 'Leclerc', (SELECT id FROM inserted_teams WHERE team_name = 'Ferrari'), 16, CURRENT_TIMESTAMP),
  ('Kevin', 'Magnussen', (SELECT id FROM inserted_teams WHERE team_name = 'Haas'), 20, CURRENT_TIMESTAMP),
  ('Lando', 'Norris', (SELECT id FROM inserted_teams WHERE team_name = 'McLaren'), 4, CURRENT_TIMESTAMP),
  ('Esteban', 'Ocon', (SELECT id FROM inserted_teams WHERE team_name = 'Alpine'), 31, CURRENT_TIMESTAMP),
  ('Sergio', 'Pérez', (SELECT id FROM inserted_teams WHERE team_name = 'Red Bull'), 11, CURRENT_TIMESTAMP),
  ('Oscar', 'Piastri', (SELECT id FROM inserted_teams WHERE team_name = 'McLaren'), 81, CURRENT_TIMESTAMP),
  ('Daniel', 'Ricciardo', (SELECT id FROM inserted_teams WHERE team_name = 'Visa Cash App RB'), 3, CURRENT_TIMESTAMP),
  ('George', 'Russell', (SELECT id FROM inserted_teams WHERE team_name = 'Mercedes'), 63, CURRENT_TIMESTAMP),
  ('Carlos', 'Sainz', (SELECT id FROM inserted_teams WHERE team_name = 'Ferrari'), 55, CURRENT_TIMESTAMP),
  ('Logan', 'Sargeant', (SELECT id FROM inserted_teams WHERE team_name = 'Williams'), 2, CURRENT_TIMESTAMP),
  ('Lance', 'Stroll', (SELECT id FROM inserted_teams WHERE team_name = 'Aston Martin'), 18, CURRENT_TIMESTAMP),
  ('Yuki', 'Tsunoda', (SELECT id FROM inserted_teams WHERE team_name = 'Visa Cash App RB'), 22, CURRENT_TIMESTAMP),
  ('Max', 'Verstappen', (SELECT id FROM inserted_teams WHERE team_name = 'Red Bull'), 1, CURRENT_TIMESTAMP),
  ('Guanyu', 'Zhou', (SELECT id FROM inserted_teams WHERE team_name = 'Kick Sauber'), 24, CURRENT_TIMESTAMP);
